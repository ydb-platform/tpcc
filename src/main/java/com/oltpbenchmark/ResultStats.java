...
public class ResultStats {
    ...
    public static class Histogram {
        ...
        private static int[] getDefaultBuckets() {
            // note, that there is a 5000 bucket here,
            // thus we can calculate number of transactions below this value precisely.
            ...
            for (int i = 112; i <= 512; i += 12) {
                bucketList.add(i);
            }

            for (int i = 750; i <= 10000; i += 250) {
                bucketList.add(i);
            }
            ...
            return bucketList.stream().mapToInt(i -> i).toArray();
        }
